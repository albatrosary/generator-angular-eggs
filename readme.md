...
# Angular 1.4.5, Angular New Router Angular and Twitter Bootstrap v4 App Generator 

This generator are using Angular1.4, Angular New Router, Twitter Bootstrap v4 and Express on Node.js. Angular we have emphasized the development life cycle.It supports the next thing for that.
