...
# Angular 1.4.5, Angular New Router, Bootstrap v4 and TingoDB(like MongoDB) App Generator 

This generator are using Angular1.4, Angular New Router, Bootstrap v4 and Express on Node.js. Instead of MongoDB, it will use the lighter [TingoDB](http://www.tingodb.com/).  
